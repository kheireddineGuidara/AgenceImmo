    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ Vite::asset('resources/images/why-choose-us-img.jpg')}}" alt="Image"
                             class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="{{ Vite::asset('resources/images/img-grid-1.jpg')}}"
                                                      alt="Untree.co"></div>
                        <div class="grid grid-2"><img src="{{ Vite::asset('resources/images/img-grid-2.jpg')}}"
                                                      alt="Untree.co"></div>
                        <div class="grid grid-3"><img src="{{ Vite::asset('resources/images/img-grid-3.jpg')}}"
                                                      alt="Untree.co"></div>
                    </div>
                </div>
