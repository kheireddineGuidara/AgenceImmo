...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            @empty
                <div class="col">
                     <i class="bi bi-0-circle-fill">Aucun bien ne correspond à votre recherche <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-0-circle-fill" viewBox="0 0 16 16">
